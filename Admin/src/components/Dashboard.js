...
const [templist,setTemplist] = useState([]);
  ...
  useEffect(()=>{
    Axios.get('https://ays-backend.vercel.app/getemployeesforadmin',{headers:{"authorization":`bearer ${localStorage.getItem("token")}`}}).then((response)=>{
  ...
  useEffect(()=>{
    Axios.get('https://ays-backend.vercel.app/getusersforadmin',{headers:{"authorization":`bearer ${localStorage.getItem("token")}`}}).then((response)=>{
    if(response.data.auth){
  ...
  useEffect(()=>{
    Axios.get('https://ays-backend.vercel.app/getordersforadmin',{headers:{"authorization":`bearer ${localStorage.getItem("token")}`}}).then((response)=>{
...
useEffect(()=>{
  ...
  Axios.get(`https://ays-backend.vercel.app/getcountforadmin?type=salon`).then((response)=>{
    setSalonCount(response.data.count)
  })

  Axios.get(`https://ays-backend.vercel.app/getcountforadmin?type=packers and movers`).then((response)=>{
    setPackersCount(response.data.count)
  })

  Axios.get(`https://ays-backend.vercel.app/getcountforadmin?type=home cleaning`).then((response)=>{
    setHomeCount(response.data.count)
  })

  Axios.get(`https://ays-backend.vercel.app/getcountforadmin?type=painting`).then((response)=>{
    setPaintingCount(response.data.count)
  })

  Axios.get(`https://ays-backend.vercel.app/getcountforadmin?type=pest control`).then((response)=>{
    setPestCount(response.data.count)
  })

  Axios.get(`https://ays-backend.vercel.app/getcountforadmin?type=appliances`).then((response)=>{
